layui.use(['upload', 'element', 'layer'], function () {
    ...
    $('#downloadTemplate').on('click', function () {
        ...
        var csvContent = '﻿用户名,密码,邮箱\n';
        csvContent += 'zhangsan,123456,zhangsan@qq.com\n';
        csvContent += 'lisi,123456,lisi@163.com\n';
        csvContent += 'wangwu,123456,wangwu@gmail.com';
